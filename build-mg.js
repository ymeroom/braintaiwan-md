// 將 mg-articles 的 5 篇 .md 轉成站內風格 HTML 頁面（重症肌無力 Myasthenia Gravis · 青綠配色）
// 自帶極簡 markdown 轉換器，無外部相依
const fs = require('fs');
const path = require('path');

const SRC = 'D:/claudecode/mg-articles';
const OUT = __dirname;
const SERIES_TAG = '重症肌無力（Myasthenia Gravis）臨床導讀';

const articles = [
  { md: '01-what-is-mg.md',             out: 'mg01.html', nav: '① 認識 MG' },
  { md: '02-antibodies-and-thymus.md',  out: 'mg02.html', nav: '② 抗體與胸腺' },
  { md: '03-clinical-and-crisis.md',    out: 'mg03.html', nav: '③ 表現與危象' },
  { md: '04-diagnosis.md',              out: 'mg04.html', nav: '④ 診斷工具' },
  { md: '05-treatment-and-targeted.md', out: 'mg05.html', nav: '⑤ 治療全景' },
];
