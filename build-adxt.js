// 將 alzheimer-dx-tools-articles 的 5 篇 .md 轉成站內風格 HTML 頁面
// 自帶極簡 markdown 轉換器（涵蓋本系列用到的語法），無外部相依
const fs = require('fs');
const path = require('path');

const SRC = 'D:/claudecode/alzheimer-dx-tools-articles';
const OUT = __dirname;
const SERIES_TAG = "阿茲海默症與相關失智症臨床評估工具 2025 指引導讀（Alzheimer's Association DETeCD-ADRD validated clinical assessment instruments）";

const articles = [
  { md: '01-informant-questionnaires.md',     out: 'adxt01.html', nav: '① 認知症狀問卷' },
  { md: '02-neuropsychiatric-mood-scales.md', out: 'adxt02.html', nav: '② 精神行為與情緒' },
  { md: '03-functional-staging-tools.md',     out: 'adxt03.html', nav: '③ 功能與分期工具' },
  { md: '04-cognitive-screening-tests.md',    out: 'adxt04.html', nav: '④ 簡式認知測驗' },
  { md: '05-telemedicine-adaptation.md',      out: 'adxt05.html', nav: '⑤ 遠距評估調整' },
];
...
function page(title, contentHtml, navItems, activeIdx, desc){
  ...
  const d = desc || '阿茲海默症與相關失智症 2025 DETeCD-ADRD 驗證過的臨床評估工具臨床導讀。';
  return `<!DOCTYPE html>
<html lang="zh-TW">
<head>
<meta charset="UTF-8">
