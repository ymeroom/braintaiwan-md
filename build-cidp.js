// 將 cidp-articles 的 10 篇 .md 轉成站內風格 HTML 頁面
// 自帶極簡 markdown 轉換器（涵蓋本系列用到的語法），無外部相依
const fs = require('fs');
const path = require('path');

const SRC = 'D:/claudecode/cidp-articles';
const OUT = __dirname;
const SERIES_TAG = 'CIDP 慢性發炎性脫髓鞘多發性神經根神經病臨床導讀';

const articles = [
  { md: '01-what-is-cidp.md', out: 'cidp01.html', nav: '① 認識 CIDP' },
  { md: '02-typical-and-variants.md', out: 'cidp02.html', nav: '② 典型與變異型' },
  { md: '03-mimics-and-spectrum.md', out: 'cidp03.html', nav: '③ 模仿者與光譜' },
  { md: '04-nerve-conduction.md', out: 'cidp04.html', nav: '④ 神經傳導' },
  { md: '05-diagnostic-algorithm.md', out: 'cidp05.html', nav: '⑤ 診斷流程' },
  { md: '06-ancillary-tests.md', out: 'cidp06.html', nav: '⑥ 輔助檢查' },
  { md: '07-first-line-treatment.md', out: 'cidp07.html', nav: '⑦ 第一線治療' },
  { md: '08-maintenance-and-outcome.md', out: 'cidp08.html', nav: '⑧ 維持與評估' },
  { md: '09-refractory-cidp.md', out: 'cidp09.html', nav: '⑨ 難治型' },
  { md: '10-future-therapies.md', out: 'cidp10.html', nav: '⑩ 未來新藥' },
];
