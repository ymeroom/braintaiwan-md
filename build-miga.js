// 將 migraine-acute-articles 的 5 篇 .md 轉成站內風格 HTML 頁面
// 自帶極簡 markdown 轉換器（涵蓋本系列用到的語法），無外部相依
const fs = require('fs');
const path = require('path');

const SRC = 'D:/claudecode/migraine-acute-articles';
const OUT = __dirname;
const SERIES_TAG = '偏頭痛急性治療 2022 台灣指引導讀（Taiwan Headache Society）';

const articles = [
  { md: '01-principles-stratified-care.md', out: 'miga01.html', nav: '① 原則與分層照護' },
  { md: '02-first-line-oral.md',            out: 'miga02.html', nav: '② 第一線口服藥' },
  { md: '03-second-line-antiemetics.md',    out: 'miga03.html', nav: '③ 第二線與止吐劑' },
  { md: '04-gepants-ditans-neuromod.md',    out: 'miga04.html', nav: '④ 新藥與神經調節' },
  { md: '05-severe-rescue-special.md',      out: 'miga05.html', nav: '⑤ 重度·急救·特殊族群' },
];
...
function page(title, contentHtml, navItems, activeIdx, desc){
  ...
  const d = desc || '偏頭痛急性治療 2022 台灣頭痛學會指引臨床導讀。';
  return `<!DOCTYPE html>
<html lang="zh-TW">
<head>
<meta charset="UTF-8">
