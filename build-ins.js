// 將 insomnia-articles 的 5 篇 .md 轉成站內風格 HTML 頁面（靛藍夜色主題）
// 自帶極簡 markdown 轉換器（涵蓋本系列用到的語法），無外部相依
const fs = require('fs');
const path = require('path');

const SRC = 'D:/claudecode/insomnia-articles';
const OUT = __dirname;
const SERIES_TAG = '失眠症 臨床導讀（國際指引彙編 2024）';

const articles = [
  { md: '01-overview-diagnosis.md',   out: 'ins01.html', nav: '① 概論與診斷' },
  { md: '02-cbti-first-line.md',      out: 'ins02.html', nav: '② CBT-I 第一線' },
  { md: '03-pharmacotherapy.md',      out: 'ins03.html', nav: '③ 藥物治療總覽' },
  { md: '04-dora-new-agents.md',      out: 'ins04.html', nav: '④ 新型 DORA' },
  { md: '05-safety-deprescribing.md', out: 'ins05.html', nav: '⑤ 安全與減藥' },
];
