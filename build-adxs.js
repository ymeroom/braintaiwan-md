// 將 alzheimer-dx-specialist-articles 的 8 篇 .md 轉成站內風格 HTML 頁面
// 自帶極簡 markdown 轉換器（涵蓋本系列用到的語法），無外部相依
const fs = require('fs');
const path = require('path');

const SRC = 'D:/claudecode/alzheimer-dx-specialist-articles';
const OUT = __dirname;
const SERIES_TAG = "阿茲海默症與相關失智症專科評估 2025 指引導讀（Alzheimer's Association DETeCD-ADRD specialty care）";

const articles = [
  { md: '01-referral-triggers.md',         out: 'adxs01.html', nav: '① 轉診時機' },
  { md: '02-specialist-evaluation.md',     out: 'adxs02.html', nav: '② 專科評估' },
  { md: '03-neuropsych-evaluation.md',     out: 'adxs03.html', nav: '③ 神經心理評估' },
  { md: '04-syndrome-etiology-map.md',     out: 'adxs04.html', nav: '④ 症候群病因地圖' },
  { md: '05-tiered-testing-framework.md',  out: 'adxs05.html', nav: '⑤ 分層檢測架構' },
  { md: '06-fdg-pet.md',                   out: 'adxs06.html', nav: '⑥ FDG PET' },
  { md: '07-csf-amyloid-pet.md',           out: 'adxs07.html', nav: '⑦ CSF與類澀蛋白PET' },
  { md: '08-genetics-apoe-dmt-era.md',     out: 'adxs08.html', nav: '⑧ 基因檢測與治療時代' },
];
...
function page(title, contentHtml, navItems, activeIdx, desc){
  ...
  const d = desc || '阿茲海默症與相關失智症 2025 DETeCD-ADRD 專科照護指引臨床導讀。';
  return `<!DOCTYPE html>
<html lang="zh-TW">
<head>
<meta charset="UTF-8">
