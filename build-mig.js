// 將 migraine-articles 的 5 篇 .md 轉成站內風格 HTML 頁面
// 自帶極簡 markdown 轉換器（涵蓋本系列用到的語法），無外部相依
const fs = require('fs');
const path = require('path');

const SRC = 'D:/claudecode/migraine-articles';
const OUT = __dirname;
const SERIES_TAG = '偏頭痛預防性治療 2022 台灣指引導讀（Taiwan Headache Society）';

const articles = [
  { md: '01-when-to-start-principles.md', out: 'mig01.html', nav: '① 開始時機與原則' },
  { md: '02-first-line-oral.md',          out: 'mig02.html', nav: '② 第一線口服藥' },
  { md: '03-second-line-oral.md',         out: 'mig03.html', nav: '③ 第二線與其他口服' },
  { md: '04-cgrp-mab.md',                 out: 'mig04.html', nav: '④ CGRP 單株抗體' },
  { md: '05-chronic-botox-special.md',    out: 'mig05.html', nav: '⑤ 慢性·肉毒·特殊族群' },
];
...
function page(title, contentHtml, navItems, activeIdx, desc){
  ...
  const d = desc || '偏頭痛預防性治療 2022 台灣頭痛學會指引臨床導讀。';
  return `<!DOCTYPE html>
<html lang="zh-TW">
<head>
<meta charset="UTF-8">
