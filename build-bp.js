// 將 bells-palsy-articles 的 5 篇 .md 轉成站內風格 HTML 頁面
// 自帶極簡 markdown 轉換器（涵蓋本系列用到的語法），無外部相依
const fs = require('fs');
const path = require('path');

const SRC = 'D:/claudecode/bells-palsy-articles';
const OUT = __dirname;
const SERIES_TAG = "Bell's palsy 臨床導讀（AAO-HNS 2013 / AAN 2012 指引）";

const articles = [
  { md: '01-diagnosis.md',              out: 'bp01.html', nav: '① 診斷與鑑別' },
  { md: '02-pathophysiology.md',        out: 'bp02.html', nav: '② 病因與解剖' },
  { md: '03-steroids.md',               out: 'bp03.html', nav: '③ 類固醇' },
  { md: '04-antivirals.md',             out: 'bp04.html', nav: '④ 抗病毒藥物' },
  { md: '05-eye-prognosis-followup.md', out: 'bp05.html', nav: '⑤ 眼睛與預後' },
];
