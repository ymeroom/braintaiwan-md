// 將 commercial-bbm-article 的市售血液檢測導讀 .md 轉成站內風格 HTML 頁面
...
const OUT = __dirname;
const SERIES_TAG = "失智症血液檢測專題：市售宣稱可診斷失智症的血液生物標記";

const articles = [
  { md: '01-commercial-blood-tests.md', out: 'cbm01.html', nav: '市售血液檢測解讀' },
];
...
function page(title, contentHtml, navItems, activeIdx, desc){
  ...
  const d = desc || '市售宣稱可診斷失智症的血液生物標記，到底能信幾分？臨床醫師的解讀。';
