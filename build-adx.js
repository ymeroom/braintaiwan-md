// 將 alzheimer-dx-articles 的 7 篇 .md 轉成站內風格 HTML 頁面
// 自帶極簡 markdown 轉換器（涵蓋本系列用到的語法），無外部相依
const fs = require('fs');
const path = require('path');

const SRC = 'D:/claudecode/alzheimer-dx-articles';
const OUT = __dirname;
const SERIES_TAG = "阿茲海默症與相關失智症診斷評估 2025 指引導讀（Alzheimer's Association DETeCD-ADRD）";

const articles = [
  { md: '01-shared-goals-whom-to-evaluate.md',      out: 'adx01.html', nav: '① 評估對象與目標' },
  { md: '02-history-present-illness.md',            out: 'adx02.html', nav: '② 病史詢問' },
  { md: '03-multidomain-systems-review.md',         out: 'adx03.html', nav: '③ 系統性回顧' },
  { md: '04-biopsychosocial-history-risk-factors.md',out: 'adx04.html', nav: '④ 危險因子病史' },
  { md: '05-examination.md',                        out: 'adx05.html', nav: '⑤ 身體評估' },
  { md: '06-diagnostic-steps-tiered-testing.md',    out: 'adx06.html', nav: '⑥ 診斷步驟與檢查' },
  { md: '07-communication-care-plan.md',            out: 'adx07.html', nav: '⑦ 溝通與照護計畫' },
];
...
function page(title, contentHtml, navItems, activeIdx, desc){
  ...
  const d = desc || '阿茲海默症與相關失智症 2025 DETeCD-ADRD 診斷評估指引臨床導讀。';
  return `<!DOCTYPE html>
<html lang="zh-TW">
<head>
<meta charset="UTF-8">
