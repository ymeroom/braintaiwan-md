...
const SRC = 'D:/claudecode/phn-articles';
const OUT = __dirname;
const SERIES_TAG = 'Postherpetic neuralgia 帶狀疱疹後神經痛臨床導讀';

const articles = [
  { md: '01-what-is-phn.md', out: 'phn01.html', nav: '① 認識 PHN' },
  { md: '02-risk-prevention-vaccine.md', out: 'phn02.html', nav: '② 風險與預防' },
  { md: '03-assessment-diagnosis.md', out: 'phn03.html', nav: '③ 評估診斷' },
  { md: '04-first-line-pharmacotherapy.md', out: 'phn04.html', nav: '④ 第一線藥物' },
  { md: '05-topical-interventional.md', out: 'phn05.html', nav: '⑤ 局部與介入' },
];
