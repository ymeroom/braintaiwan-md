...
const SRC = 'D:/claudecode/fabry-articles';
const OUT = __dirname;
const SERIES_TAG = 'Classic Fabry disease 臨床導讀（專家共識 2022）';

const articles = [
  { md: '01-what-is-classic-fabry.md', out: 'fab01.html', nav: '① 認識疾病' },
  { md: '02-biomarkers-monitoring.md', out: 'fab02.html', nav: '② 生物標記' },
  { md: '03-cardiac-involvement.md', out: 'fab03.html', nav: '③ 心臟侵犯' },
  { md: '04-renal-cerebrovascular.md', out: 'fab04.html', nav: '④ 腎與腦血管' },
  { md: '05-treatment.md', out: 'fab05.html', nav: '⑤ 治療' },
];
