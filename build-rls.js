// 將 rls-articles 的 5 篇 .md 轉成站內風格 HTML 頁面（不寧腿症候群 RLS · 睡眠藍配色）
// 自帶極簡 markdown 轉換器，無外部相依
const fs = require('fs');
const path = require('path');

const SRC = 'D:/claudecode/rls-articles';
const OUT = __dirname;
const SERIES_TAG = '不寧腿症候群（Restless Legs Syndrome）臨床導讀';

const articles = [
  { md: '01-what-is-rls.md',             out: 'rls01.html', nav: '① 認識 RLS' },
  { md: '02-pathophysiology.md',         out: 'rls02.html', nav: '② 腦缺鐵的矛盾' },
  { md: '03-secondary-and-iron.md',      out: 'rls03.html', nav: '③ 次發與補鐵' },
  { md: '04-pharmacologic-treatment.md', out: 'rls04.html', nav: '④ 藥物治療' },
  { md: '05-nondrug-and-prognosis.md',   out: 'rls05.html', nav: '⑤ 非藥物與預後' },
];
