// 將 bbm-guideline-articles 的 4 篇 .md 轉成站內風格 HTML 頁面
// 自帶極簡 markdown 轉換器（涵蓋本系列用到的語法），無外部相依
const fs = require('fs');
const path = require('path');

const SRC = 'D:/claudecode/bbm-guideline-articles';
const OUT = __dirname;
const SERIES_TAG = "阿茲海默症血液生物標記 2025 臨床指引導讀（Alzheimer's Association blood-based biomarkers CPG, specialized care）";

const articles = [
  { md: '01-why-this-guideline.md',   out: 'bbm01.html', nav: '① 為什麼需要這份指引' },
  { md: '02-triaging-test.md',        out: 'bbm02.html', nav: '② 初篩測試門檻' },
  { md: '03-confirmatory-test.md',    out: 'bbm03.html', nav: '③ 確診測試與31種檢測' },
  { md: '04-benefits-risks-future.md',out: 'bbm04.html', nav: '④ 效益風險與未來趨勢' },
];
...
function page(title, contentHtml, navItems, activeIdx, desc){
  ...
  const d = desc || 'Alzheimer\'s Association 2025 血液生物標記（BBM）臨床指引導讀，專為記憶門診醫師整理。';
  return `<!DOCTYPE html>
<html lang="zh-TW">
<head>
<meta charset="UTF-8">
