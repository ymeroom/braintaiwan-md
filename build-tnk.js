// 將 tenecteplase-articles 的 3 篇 .md 轉成站內風格 HTML 頁面
// 自帶極簡 markdown 轉換器（涵蓋本系列用到的語法），無外部相依
const fs = require('fs');
const path = require('path');

const SRC = 'D:/claudecode/tenecteplase-articles';
const OUT = __dirname;
const SERIES_TAG = '急性缺血性腦中風 Tenecteplase 靜脈血栓溶解治療共識導讀（台灣腦中風學會 2026）';

const articles = [
  { md: '01-why-tenecteplase.md',       out: 'tnk01.html', nav: '① TNK 為何登場' },
  { md: '02-dose-and-low-weight.md',    out: 'tnk02.html', nav: '② 劑量與低體重' },
  { md: '03-preparation-and-safety.md', out: 'tnk03.html', nav: '③ 配製與病安' },
];
...
function page(title, contentHtml, navItems, activeIdx, desc){
  ...
  const d = desc || '台灣腦中風學會 2026 Tenecteplase 靜脈血栓溶解治療共識臨床導讀。';
  return `<!DOCTYPE html>
<html lang="zh-TW">
<head>
<meta charset="UTF-8">
...
@media(max-width:600px){
  ...
  .site-title{font-size:21pt;overflow-wrap:anywhere}
  main{padding:22px 16px}
  .article{padding:28px 22px;overflow-wrap:anywhere}
