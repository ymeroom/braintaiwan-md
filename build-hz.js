// 將 herpes-zoster-articles 的 5 篇 .md 轉成站內風格 HTML 頁面
// 自帶極簡 markdown 轉換器（涵蓋本系列用到的語法），無外部相依
const fs = require('fs');
const path = require('path');

const SRC = 'D:/claudecode/herpes-zoster-articles';
const OUT = __dirname;
const SERIES_TAG = '急性帶狀皰疹臨床導讀（Acute Herpes Zoster）';

const articles = [
  { md: '01-virology-presentation.md',    out: 'hz01.html', nav: '① 病毒學與表現' },
  { md: '02-diagnosis-differential.md',   out: 'hz02.html', nav: '② 診斷與鑑別' },
  { md: '03-antiviral-corticosteroid.md', out: 'hz03.html', nav: '③ 抗病毒與類固醇' },
  { md: '04-complications.md',            out: 'hz04.html', nav: '④ 併發症總覽' },
  { md: '05-phn-vaccine.md',              out: 'hz05.html', nav: '⑤ PHN 與疫苗' },
];
