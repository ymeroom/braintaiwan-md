// 將 ais-articles 的 5 篇 .md 轉成站內風格 HTML 頁面
// 自帶極簡 markdown 轉換器（涵蓋本系列用到的語法），無外部相依
const fs = require('fs');
const path = require('path');

const SRC = 'D:/claudecode/ais-articles';
const OUT = __dirname;
const SERIES_TAG = '急性缺血性腦中風 2026 指引導讀（AHA/ASA Acute Ischemic Stroke）';

const articles = [
  { md: '01-systems-prehospital.md',            out: 'ais01.html', nav: '① 系統與院前' },
  { md: '02-imaging-selection.md',              out: 'ais02.html', nav: '② 影像分流' },
  { md: '03-iv-thrombolysis.md',                out: 'ais03.html', nav: '③ 靜脈溶栓' },
  { md: '04-thrombectomy.md',                   out: 'ais04.html', nav: '④ 機械取栓' },
  { md: '05-supportive-secondary-prevention.md',out: 'ais05.html', nav: '⑤ 支持與次級預防' },
];
...
function page(title, contentHtml, navItems, activeIdx, desc){
  ...
  const d = desc || '急性缺血性中風 2026 AHA/ASA 指引臨床導讀。';
  return `<!DOCTYPE html>
<html lang="zh-TW">
<head>
<meta charset="UTF-8">
